...
class BuyDefensaPage extends StatefulWidget {
  @override
  _BuyDefensaPageState createState() => _BuyDefensaPageState();
}

class _BuyDefensaPageState extends State<BuyDefensaPage> {
  ...
  double _getPriceBySize(String itemName) {
    if (itemName.contains("Premium")) return 100.0;
    if (itemName.contains("Media")) return 50.0;
    return 15.0;
  }
  ...
  Widget build(BuildContext context) {
    ...
    List<Item> waterItems =
        itemsProvider.items.where((item) => item.tipus == "defensa").toList();
    final Usuari? usuari =
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('Comprar Defensas'),
